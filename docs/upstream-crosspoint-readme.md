# CrossPoint Reader (upstream README)

This is the upstream CrossPoint README, kept for reference and for the other boards this tree still builds. The X4 Pro edition is described in the [main README](../README.md).
...
```
   ...
   For this fork's X4 Pro build, also erase `otadata` first; see [First install over USB](../README.md#first-install-over-usb).
